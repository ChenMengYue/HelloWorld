...
@implementation NSString (AbountUrl)
...
//        //类似项目中h5用到vue加锚点的链接(http://xxx.com/#/newsSearch?title=哈哈&time=xxx)，其中的#号也会转码
//        NSString *unreserved = @"!*'\"();:@&=+$,/?%#[]%";
//        NSMutableCharacterSet *allowed = [NSMutableCharacterSet alphanumericCharacterSet];// 字母数字集合
...
@implementation NSString (ShowViewInfo)
